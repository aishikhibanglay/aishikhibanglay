        ...
        >
          ...
          <div className="space-y-12 text-lg text-foreground/90 leading-relaxed">
            <section>
              ...
              <p>
                কুকি (Cookies) হলো ছোট ডেটা ফাইল বা টেক্সট ফাইল যা ওয়েবসাইটগুলো আপনার কম্পিউটার, মোবাইল ফোন বা অন্যান্য ডিভাইসে সংরক্ষণ করে যখন আপনি সেই ওয়েবসাইটগুলো ভিজিট করেন। এগুলো আপনার ব্রাউজিং অভিজ্ঞতা উন্নত করতে, আপনার পছন্দগুলো মনে রাখতে এবং ওয়েবসাইট কীভাবে কাজ করছে তা বুঝতে আমাদের সাহায্য করে।
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-6 pl-2">
                <div className="border-l-4 border-primary pl-4 py-1">
                  ...
                  <p>এই কুকিগুলো ওয়েবসাইটের মৌলিক কাজগুলো সম্পাদন করার জন্য অপরিহার্য। এগুলো ছাড়া ওয়েবসাইট সঠিকভাবে কাজ নাও করতে পারে।</p>
                </div>
                
                <div className="border-l-4 border-blue-500 pl-4 py-1">
                  <h3 className="font-bold text-xl mb-2">অ্যানালিটিক্স কুকি (Analytics Cookies)</h3>
                  <p>এই কুকিগুলো আমাদের বুঝতে সাহায্য করে দর্শকরা কীভাবে আমাদের ওয়েবসাইট ব্যবহার করেন। যেমন: কোন পেজগুলো বেশি দেখা হচ্ছে, ভিজিটররা কতক্ষণ সময় কাটাচ্ছেন। আমরা সাধারণত এর জন্য গুগল অ্যানালিটিক্স ব্যবহার করি।</p>
                </div>
                
                <div className="border-l-4 border-amber-500 pl-4 py-1">
                  <h3 className="font-bold text-xl mb-2">বিজ্ঞাপন কুকি (Advertising Cookies)</h3>
                  <p>এই কুকিগুলো আপনাকে আপনার আগ্রহ অনুযায়ী প্রাসঙ্গিক বিজ্ঞাপন দেখাতে ব্যবহৃত হয়। তৃতীয় পক্ষের বিজ্ঞাপনদাতারা (যেমন Google AdSense) এই কুকিগুলো সেট করতে পারে।</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                আমাদের ওয়েবসাইটে Google AdSense এর মাধ্যমে বিজ্ঞাপন প্রদর্শিত হয়। গুগল এবং তার পার্টনাররা আপনার ব্রাউজারে কুকি (যেমন DART কুকি) সেট করতে পারে।
              </p>
            ...
            <section>
              ...
              <p>
                আপনি চাইলে আপনার ডিভাইসে কুকি সংরক্ষণ নিয়ন্ত্রণ বা মুছে ফেলতে পারেন। প্রায় সব ব্রাউজারেই সেটিংসে গিয়ে কুকি ব্লক বা ডিলিট করার অপশন থাকে। তবে মনে রাখবেন, সমস্ত কুকি ব্লক করলে আমাদের ওয়েবসাইটের কিছু ফিচার সঠিকভাবে কাজ নাও করতে পারে।
              </p>
            </section>
            ...
            <section className="bg-secondary/50 p-6 md:p-8 rounded-2xl border border-border mt-12">
              ...
              <p className="mb-4">
                আমাদের কুকি পলিসি সম্পর্কে আপনার কোনো প্রশ্ন বা মতামত থাকলে আমাদের জানান:
              </p>
