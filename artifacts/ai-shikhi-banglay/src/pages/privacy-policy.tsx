          ...
          <div className="space-y-12 text-lg text-foreground/90 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>নন-পার্সোনাল তথ্য:</strong> আমাদের ওয়েবসাইট ভিজিট করার সময় আপনার ব্রাউজার ধরন, আইপি অ্যাড্রেস, অপারেটিং সিস্টেম, এবং ভিজিটের সময়ের তথ্য স্বয়ংক্রিয়ভাবে সংগৃহীত হতে পারে।</li>
              </ul>
            </section>
            <section>
              <h2 className="text-2xl font-bold text-primary mb-4">কুকি নীতি (Cookies)</h2>
              <p>আমাদের ওয়েবসাইট কুকি (Cookies) ব্যবহার করে। কুকি হলো ছোট টেক্সট ফাইল যা আপনার ডিভাইসে সংরক্ষিত থাকে এবং আপনার ব্রাউজিং অভিজ্ঞতাকে আরও উন্নত করতে সাহায্য করে।</p>
            </section>
            <section>
              <h2 className="text-2xl font-bold text-primary mb-4">Google AdSense এবং বিজ্ঞাপন</h2>
              <p>আমাদের ওয়েবসাইটে Google AdSense বা অন্যান্য তৃতীয় পক্ষের বিজ্ঞাপন প্রদর্শিত হতে পারে। গুগল সহ তৃতীয় পক্ষের বিক্রেতারা কুকি ব্যবহার করে ব্যবহারকারীর পূর্ববর্তী ভিজিটের ওপর ভিত্তি করে বিজ্ঞাপন প্রদর্শন করে।</p>
            </section>
            <section>
              <h2 className="text-2xl font-bold text-primary mb-4">তৃতীয় পক্ষের লিঙ্ক (Third Party Links)</h2>
              <p>আমাদের ওয়েবসাইটে অন্যান্য ওয়েবসাইটের লিঙ্ক থাকতে পারে। তৃতীয় পক্ষের ওয়েবসাইটের কন্টেন্ট বা কার্যক্রমের জন্য আমরা দায়ী নই।</p>
            </section>
            <section>
            ...
            <section className="bg-secondary/50 p-6 md:p-8 rounded-2xl border border-border mt-12">
              ...
              <p className="mb-4">এই প্রাইভেসি পলিসি সম্পর্কে আপনার কোনো প্রশ্ন থাকলে আমাদের সাথে যোগাযোগ করুন:</p>
