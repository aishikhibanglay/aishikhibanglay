...
// ─── Hero AI illustration (pure SVG, no external dependency) ───────────────
  ...
  return (
    <div className="relative w-full max-w-md mx-auto select-none">
      <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
        ...
        <path d="M185 185 Q193 178 200 185 Q207 178 215 185 Q220 193 215 200 Q220 207 215 215 Q207 222 200 215 Q193 222 185 215 Q180 207 185 200 Q180 193 185 185Z"
          fill="none" stroke="rgba(6,182,212,0.6)" strokeWidth="1.5" />
        ...
        <foreignObject x="68" y="88" width="24" height="24">
          <div xmlns="http://www.w3.org/1999/xhtml" style={{ color: "rgb(192,132,252)", display:"flex", alignItems:"center", justifyContent:"center", width:"100%", height:"100%" }}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14"><path d="M12 2a4 4 0 0 1 4 4 4 4 0 0 1-4 4 4 4 0 0 1-4-4 4 4 0 0 1 4-4m0 10c4.42 0 8 1.79 8 4v2H4v-2c0-2.21 3.58-4 8-4z"/></svg>
          </div>
        </foreignObject>
        ...
        {/* Orbiting dot */}
        <circle cx="200" cy="40" r="6" fill="rgba(6,182,212,0.9)" style={{ transformOrigin: "200px 200px", animation: "spin 8s linear infinite" }} />
      </svg>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-8 flex-wrap">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="text-white font-semibold">৫,০০০+</span> বাংলাভাষী ইতিমধ্যে AI শিখছেন
                </p>
              </div>

              <div className="flex flex-col sm:flex-row items-start gap-3">
                <Link href={settings.hero_cta_primary_href || "/blog"}>
                  <Button size="lg" className="w-full sm:w-auto gap-2 text-base px-8 h-13 font-semibold shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:shadow-[0_0_30px_rgba(6,182,212,0.6)] transition-shadow" data-testid="button-start-learning">
                    {settings.hero_cta_primary || "শেখা শুরু করুন"} <ArrowRight className="w-5 h-5" />
                  </Button>
                </Link>
                <Link href={settings.hero_cta_secondary_href || "/tools"}>
                  <Button size="lg" variant="outline" className="w-full sm:w-auto gap-2 text-base px-8 h-13 text-muted-foreground" data-testid="button-browse-tools">
      ...
      <section className="border-y border-border bg-secondary/20">
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              { icon: Users, value: "৫,০০০+", label: "সক্রিয় পাঠক", color: "text-cyan-400" },
              { icon: FileText, value: "৫০+", label: "আর্টিকেল ও গাইড", color: "text-purple-400" },
              { icon: Wrench, value: "৩০+", label: "AI টুলস রিভিউ", color: "text-amber-400" },
              { icon: Youtube, value: "১০০%", label: "বাংলায় কন্টেন্ট", color: "text-rose-400" },
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            {subscribeStatus === "success" ? (
              ...
              <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={handleSubscribe}>
                ...
                <Button
                  type="submit"
                  className="h-12 px-7 font-semibold flex-shrink-0"
                  disabled={subscribeStatus === "loading"}
